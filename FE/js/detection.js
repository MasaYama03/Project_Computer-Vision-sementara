                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="card mb-6">
                                ...
                                <div class="p-4 space-y-4">
                                    ...
                                    <div>
                                        <label class="form-label block mb-1">Trigger Time (seconds):</label>
                                        <div class="relative w-full">
                                            <!-- Slider and value -->
                                            <div class="flex items-center gap-4 w-full">
                                                <div class="flex-1">
                                                    <input type="range" id="trigger-time" min="1" max="10" value="${currentAlarmSettings.triggerTime}" 
                                                           class="w-full" oninput="updateTriggerTime(this.value)">
                                                </div>
                                                <span class="text-black font-medium w-10 ml-2">${currentAlarmSettings.triggerTime}s</span>
                                            </div>
                                            
                                            <!-- Min/Max labels -->
                                            <div class="flex justify-between text-sm text-gray-500 mt-1">
                                                <span>1s</span>
                                                <span class="ml-auto mr-14">10s</span>
                                            </div>
                                        </div>
                                    </div>
...
function updateTriggerTime(value) {
    ...
    const displayElement = document.querySelector('#trigger-time').nextElementSibling;
    if (displayElement) {
...
// Alarm sound management variables (simplified)
